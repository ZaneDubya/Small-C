...
extern int calloc(unsigned n, unsigned size);
...
extern int fgets(char *str, unsigned size, unsigned fd);
...
extern int getarg(int n, char *s, int size, int argc, int argv[]);
extern int getchar();
...
extern int itod(int nbr, char str[], int sz);
extern int itoo(int nbr, char str[], int sz);
extern int itou(int nbr, char str[], int sz);
...
extern int skip(int n, char *str);
extern int strcat(char *s, char *t);
extern int strchr(char *str, char c);
extern int strcmp(char *s, char *t);
extern int strcpy(char *s, char *t);
extern int strlen(char *s);
extern int strncat(char *s, char *t, int n);
extern int strncmp(char *s, char *t, int n);
extern int strncpy(char *dest, char *sour, int n);
extern int strrchr(char *s, char c);
